...
def plot(paths, num_points, total_time, resolution, T, past_values, Movie):
    ...
    if Movie == None:
        ...
        def make_frame(t):
            ...
            ax[0][0].plot(all_outputs["x0"][:i], all_outputs["y0"][:i], linestyle='--', color='tab:blue', label='_nolegend_')
            ax[0][0].plot(all_outputs["x1"][:i], all_outputs["y1"][:i], linestyle='--', color='tab:orange', label='_nolegend_')

            ax[0][0].plot(all_outputs["x0"][i], all_outputs["y0"][i], marker='o', color='tab:blue')
            ax[0][0].plot(all_outputs["x1"][i], all_outputs["y1"][i], marker='o', color='tab:orange')
            ...
            ax[0][0].set_ylabel('Y [m]')
            ax[0][0].grid()
            ax[0][0].legend(['Vehicle Path 0', 'Vehicle Path 1', 'Vehicle 0', 'Vehicle 1'], loc='upper right')
            ...
            ax[1][0].set_ylabel('velocity [m/s]')
            ax[1][0].grid()
            ax[1][0].legend(['Vehicle 0', 'Vehicle 1'], loc='upper right')
            ...
            ax[1][1].set_xlabel('time [s]')
            ax[1][1].set_ylabel('Broadcasts')
            ax[1][1].legend(['Vehicle 0', 'Vehicle 1'], loc='upper right')
