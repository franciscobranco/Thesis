...
def simulation(file_name):
    ...
    cpf_params = {
        ...
        "theta": 0.99,
        "k_csi0": nominal_speed_profile - 0.1,
        "k_csi1": (nominal_speed_profile -0.1 ) * p1.total_distance / p0.total_distance ,
    ...
    auv_system = sb.DoubleAUVCPFETC(p0, p1, gamma=1, k1=1, k2=0.3, k_delta=0.5, theta_a=0.8, cpf_params=cpf_params, etc_type="Time", history=True, dt=dt)
