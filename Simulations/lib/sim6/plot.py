...
def plot(paths, num_points, total_time, resolution, T, past_values):
    ...
    if Movie == False:
        ...
        ax[0][0].plot(all_outputs["x_follower0"], all_outputs["y_follower0"], linestyle='--', color='red', label='_nolegend_')
        ax[0][0].plot(all_outputs["x_follower1"], all_outputs["y_follower1"], linestyle='--', color='magenta', label='_nolegend_')
        ...
        ax[0][0].plot(all_outputs["x_follower0"][-1], all_outputs["y_follower0"][-1], color='r', marker=(3, 0, 360 * all_outputs["theta_m_follower0"][-1] / (2*pi) - 90), markersize=10)
        ax[0][0].plot(all_outputs["x_follower1"][-1], all_outputs["y_follower1"][-1], color='m', marker=(3, 0, 360 * all_outputs["theta_m_follower1"][-1] / (2*pi) - 90), markersize=10)
        ...
        ax[0][0].legend([
            ...
            'virtual circle',
            'tracker0',
            'tracker1'], bbox_to_anchor=(0.75, 0.75))
        ...
        ax[1][0].plot(T, all_outputs["velocity_follower0"])
        ax[1][0].plot(T, all_outputs["velocity_follower1"])
        ...
        ax[0][1].plot(T, all_outputs["s_follower0"])
        ax[0][1].plot(T, all_outputs["s_follower1"])
        #ax[0][1].plot(T[:i], all_outputs["s1"][:i])
        ax[0][1].set_xlabel('time [s]')
        ax[0][1].legend(['difference', 'tracker0 s', 'tracker1 s'])
        ax[0][1].grid()
        ...
        ax[1][1].scatter(cpf_follower0["broadcasts"], np.full(len(cpf_follower0["broadcasts"]), 3), c='r', marker='+')
        ax[1][1].scatter(cpf_follower1["broadcasts"], np.full(len(cpf_follower1["broadcasts"]), 4), c='m', marker='+')
        ax[1][1].set_xlabel('time [s]')
        ax[1][1].legend(['target0', 'target1', 'target2', 'tracker0', 'tracker1'])
