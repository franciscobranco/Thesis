...
import lib.sim8_2.systembuild as sb
import lib.sim8_2.plot as plotting


def simulation(file_name):
    if file_name != "":
        f = open("lib\sim8_2\\" + file_name + ".txt", 'wb')
    ...
    auv_system = sb.DoubleASVMPFOnSingleAUVTargetPursuit(
        p_target1,
        p_tracker0,
        p_tracker1,
        pf_params=pf_params,
