...
class DoubleASVMPFOnSingleAUVTargetPursuit:
    def __init__(self, path_target1, path_tracker0, path_tracker1, pf_params=None, cpf_params_tracker=None, target_speed=1, ekf_params=None, time_halted=50, etc_type="Time", history=False, dt=1):
        self.dt = dt
    ...
    def update(self, t):
        ...
        inputs_kine_target1["velocity"] = self.target_speed
        inputs_pf_target1["velocity"] = self.target_speed
        ...
        outputs["velocity_target1"] = self.target_speed
