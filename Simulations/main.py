...
if __name__ == '__main__':
    ...
    answer = input("Create new simulation?[y/N] ")
    if answer == "Yes" or answer == "yes" or answer == "Y" or answer == "y" or answer == "YES":
        name = input("Name your simulation: ")
        run.simulation(name)
    else:
        name = input("Specify the name of the simulation file you wish to load: ")
    answer = input("Create Animation Movie?[y/N] ")
    if answer == "Y" or answer == "y" or answer == "yes" or answer == "Yes" or answer == "YES":
        Movie = simulation_path + name
    else:
        Movie = None
    ...
    if file_exists:
        ...
        with open(simulation_path + name + ".txt", 'rb') as f:
            ...
            plotting.plot(paths, num_points, total_time, resolution, T, past_values, Movie)
            f.close()
    else:
